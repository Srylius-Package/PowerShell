function Srylius-Write {
    <#
    .SYNOPSIS
    Srylius-Write is a wrapper around Write-Host delivering a lot of additional features for easier color options.
    ...
    .EXAMPLE
    Srylius-Write -Text "Red ", "Green ", "Yellow " -Color Red,Green,Yellow

    .EXAMPLE
    Srylius-Write -Text "This is text in Green ",
                      "followed by red ",
    ...
    .EXAMPLE
    Srylius-Write "1. ", "Option 1" -Color Yellow, Green
    Srylius-Write "2. ", "Option 2" -Color Yellow, Green
    Srylius-Write "3. ", "Option 3" -Color Yellow, Green
    Srylius-Write "4. ", "Option 4" -Color Yellow, Green
    Srylius-Write "9. ", "Press 9 to exit" -Color Yellow, Gray -LinesBefore 1

    .EXAMPLE
    Srylius-Write -LinesBefore 2 -Text "This little ","message is ", "written to log ", "file as well." `
                -Color Yellow, White, Green, Red, Red -LogFile "C:\testing.txt" -TimeFormat "yyyy-MM-dd HH:mm:ss"
    Srylius-Write -Text "This can get ","handy if ", "want to display things, and log actions to file ", "at the same time." `
                -Color Yellow, White, Green, Red, Red -LogFile "C:\testing.txt"

    .EXAMPLE
    Srylius-Write -T "My text", " is ", "all colorful" -C Yellow, Red, Green -B Green, Green, Yellow
    Srylius-Write -t "my text" -c yellow -b green
    Srylius-Write -text "my text" -c red

    .EXAMPLE
    Srylius-Write -Text "Testuję czy się ładnie zapisze, czy będą problemy" -Encoding unicode -LogFile 'C:\temp\testinggg.txt' -Color Red -NoConsoleOutput
        ...
        Do {
            ...
            try {
                ...
                if ($Saved -eq $false -and $Retry -eq $LogRetry) {
                    Write-Warning "Srylius-Write - Couldn't write to log file $($_.Exception.Message). Tried ($Retry/$LogRetry))"
                } else {
                    Write-Warning "Srylius-Write - Couldn't write to log file $($_.Exception.Message). Retrying... ($Retry/$LogRetry)"
                }
            }
